...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-dark">
		...
		<form class="form-inline ml-3" action="ip-lookup.php" method="get">
...
?>" class="nav-link" target="_blank" data-toggle="tooltip" title="Visit Site" data-toggle="tooltip" data-placement="bottom">
...
?>">
              <i class="fas fa-info-circle"></i>&nbsp; <p>System Information</p>
           </a>
        </li>
...
?>">
              <i class="fas fa-globe"></i>&nbsp; <p>Live Traffic (Lite)</p>
           </a>
        </li>
